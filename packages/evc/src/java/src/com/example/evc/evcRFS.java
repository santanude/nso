...
import com.example.evc.namespaces.*;
...
public class evcRFS {
    ...
    @ServiceCallback(servicePoint="evc-servicepoint",
     ...
     */
    @ActionCallback(callPoint="evc-self-test", callType=ActionCBType.INIT)
     ...
     */
    @ActionCallback(callPoint="evc-self-test", callType=ActionCBType.ACTION)
